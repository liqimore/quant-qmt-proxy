...
class DataGrpcService(data_pb2_grpc.DataServiceServicer):
    ...
    def GetMarketData(
        self, request: data_pb2.MarketDataRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            return data_pb2.MarketDataBatchResponse(
                data=pb_responses, status=common_pb2.Status(code=0, message="success")
            )
    ...
    def GetFinancialData(
        self, request: data_pb2.FinancialDataRequest, context: grpc.ServicerContext
    ...
    def GetSectorList(
        ...
        try:
            ...
            return data_pb2.SectorListResponse(
                sectors=sectors, status=common_pb2.Status(code=0, message="success")
            )

        except DataServiceException as e:
            context.set_code(grpc.StatusCode.INVALID_ARGUMENT)
            context.set_details(str(e))
            return data_pb2.SectorListResponse(status=common_pb2.Status(code=400, message=str(e)))
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.SectorListResponse(status=common_pb2.Status(code=500, message=str(e)))

    def GetIndexWeight(
        self, request: data_pb2.IndexWeightRequest, context: grpc.ServicerContext
    ) -> data_pb2.IndexWeightResponse:
        """获取指数权重"""
        try:
            # 转换请求
            rest_request = RestIndexWeightRequest(
                index_code=request.index_code, date=request.date if request.date else None
            )
    ...
    def GetTradingCalendar(
        self, request: data_pb2.TradingCalendarRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_details(str(e))
            return data_pb2.TradingCalendarResponse(
                year=request.year, status=common_pb2.Status(code=400, message=str(e))
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.TradingCalendarResponse(
                year=request.year, status=common_pb2.Status(code=500, message=str(e))
            )

    def GetInstrumentInfo(
        self, request: data_pb2.InstrumentInfoRequest, context: grpc.ServicerContext
    ...
    def GetETFInfo(
        self, request: data_pb2.ETFInfoRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_details(str(e))
            return data_pb2.ETFInfoResponse(
                etf_code=request.etf_code, status=common_pb2.Status(code=500, message=str(e))
            )

    def _convert_market_data_request(
        self, pb_request: data_pb2.MarketDataRequest
    ) -> RestMarketDataRequest:
        """转换 protobuf 请求为内部模型"""
        # 周期类型映射
        period_map = {
    ...
    def GetInstrumentType(
        self, request: data_pb2.InstrumentTypeRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            return data_pb2.InstrumentTypeResponse(
                data=info, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
    ...
    def GetHolidays(
        ...
        try:
            ...
            return data_pb2.HolidayInfoResponse(
                holidays=result.holidays, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.HolidayInfoResponse(status=common_pb2.Status(code=500, message=str(e)))
    ...
    def GetConvertibleBondInfo(
        ...
        try:
            ...
            return data_pb2.ConvertibleBondListResponse(
                bonds=bonds, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
    ...
    def GetIpoInfo(
        ...
        try:
            ...
            return data_pb2.IpoInfoListResponse(
                ipos=ipos, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.IpoInfoListResponse(status=common_pb2.Status(code=500, message=str(e)))
    ...
    def GetPeriodList(
        ...
        try:
            ...
            return data_pb2.PeriodListResponse(
                periods=result.periods, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            # 检查是否为不支持的功能
            error_msg = str(e)
    ...
    def GetDataDir(
        ...
        try:
            ...
            return data_pb2.DataDirResponse(
                data_dir=result.data_dir, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.DataDirResponse(status=common_pb2.Status(code=500, message=str(e)))

    # ==================== 阶段2: 行情数据获取接口实现 ====================

    def GetLocalData(
        self, request: data_pb2.LocalDataRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            return data_pb2.LocalDataResponse(
                data=data_map, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.LocalDataResponse(status=common_pb2.Status(code=500, message=str(e)))

    def GetFullTick(
        self, request: data_pb2.FullTickRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.FullTickResponse(status=common_pb2.Status(code=500, message=str(e)))

    def GetDividFactors(
        self, request: data_pb2.DividFactorsRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            return data_pb2.DividFactorsResponse(
                factors=factors, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.DividFactorsResponse(status=common_pb2.Status(code=500, message=str(e)))

    def GetFullKline(
        self, request: data_pb2.FullKlineRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.FullKlineResponse(status=common_pb2.Status(code=500, message=str(e)))

    # ==================== 阶段3: 数据下载接口实现 ====================

    def DownloadHistoryData(
        self, request: data_pb2.DownloadHistoryDataRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.DownloadResponse(rpc_status=common_pb2.Status(code=500, message=str(e)))

    def DownloadHistoryDataBatch(
        self, request: data_pb2.DownloadHistoryDataBatchRequest, context: grpc.ServicerContext
    ) -> data_pb2.DownloadResponse:
        """批量下载历史数据"""
        try:
            result = self.data_service.download_history_data_batch(
                list(request.stock_list), request.period, request.start_time, request.end_time
            )
    ...
    def DownloadFinancialData(
        self, request: data_pb2.DownloadFinancialDataRequest, context: grpc.ServicerContext
    ) -> data_pb2.DownloadResponse:
        """下载财务数据"""
        try:
    ...
    def DownloadIndexWeight(
        self, request: data_pb2.DownloadIndexWeightRequest, context: grpc.ServicerContext
    ) -> data_pb2.DownloadResponse:
        """下载指数权重"""
        try:
    ...
    def DownloadHistoryContracts(
        self, request: data_pb2.DownloadHistoryContractsRequest, context: grpc.ServicerContext
    ) -> data_pb2.DownloadResponse:
        """下载历史合约数据"""
        try:
    ...
    def CreateSectorFolder(
        self, request: data_pb2.CreateSectorFolderRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            return data_pb2.CreateSectorFolderResponse(
                created_name=result, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
    ...
    def CreateSector(
        self, request: data_pb2.CreateSectorRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.CreateSectorResponse(status=common_pb2.Status(code=500, message=str(e)))

    def AddSector(
        self, request: data_pb2.AddSectorRequest, context: grpc.ServicerContext
    ) -> data_pb2.AddSectorResponse:
        """添加股票到板块"""
        try:
            self.data_service.add_sector(request.sector_name, list(request.stock_list))

            return data_pb2.AddSectorResponse(status=common_pb2.Status(code=0, message="success"))
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.AddSectorResponse(status=common_pb2.Status(code=500, message=str(e)))

    def RemoveStockFromSector(
        self, request: data_pb2.RemoveStockFromSectorRequest, context: grpc.ServicerContext
    ) -> data_pb2.RemoveStockFromSectorResponse:
        """从板块移除股票"""
        try:
            result = self.data_service.remove_stock_from_sector(
                request.sector_name, list(request.stock_list)
            )

            return data_pb2.RemoveStockFromSectorResponse(
                success=result, status=common_pb2.Status(code=0, message="success")
            )
        except Exception as e:
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.RemoveStockFromSectorResponse(
                success=False, status=common_pb2.Status(code=500, message=str(e))
            )

    def RemoveSector(
        self, request: data_pb2.RemoveSectorRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.RemoveSectorResponse(status=common_pb2.Status(code=500, message=str(e)))

    def ResetSector(
        self, request: data_pb2.ResetSectorRequest, context: grpc.ServicerContext
    ) -> data_pb2.ResetSectorResponse:
        """重置板块"""
        try:
            result = self.data_service.reset_sector(request.sector_name, list(request.stock_list))
    ...
    def GetL2Quote(
        self, request: data_pb2.L2QuoteRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.L2QuoteResponse(status=common_pb2.Status(code=500, message=str(e)))

    def GetL2Order(
        self, request: data_pb2.L2OrderRequest, context: grpc.ServicerContext
        ...
        try:
            ...
            context.set_code(grpc.StatusCode.INTERNAL)
            context.set_details(str(e))
            return data_pb2.L2OrderResponse(status=common_pb2.Status(code=500, message=str(e)))

    def GetL2Transaction(
        self, request: data_pb2.L2TransactionRequest, context: grpc.ServicerContext
    ...
    def SubscribeQuote(self, request: data_pb2.SubscriptionRequest, context: grpc.ServicerContext):
        """
        ...
        try:
            ...
            subscription_id = subscription_manager.subscribe_quote(
                symbols=list(request.symbols), adjust_type=request.adjust_type or "none"
            )
    ...
    def SubscribeWholeQuote(
        self, request: data_pb2.WholeQuoteRequest, context: grpc.ServicerContext
    ):
        """
    ...
    def UnsubscribeQuote(
        self, request: data_pb2.UnsubscribeRequest, context: grpc.ServicerContext
    ...
    def GetSubscriptionInfo(
        self, request: data_pb2.SubscriptionInfoRequest, context: grpc.ServicerContext
    ...
    def ListSubscriptions(
        ...
        try:
            ...
            return data_pb2.SubscriptionListResponse(
                subscriptions=sub_list, status=common_pb2.Status(code=0, message="success")
            )
